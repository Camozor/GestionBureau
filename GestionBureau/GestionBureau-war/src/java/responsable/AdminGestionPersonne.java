...
import EntitesGestionBureau.AbstractFacade;
import EntitesGestionBureau.Personne;
import EntitesGestionBureau.PersonneFacadeLocal;
...
public class AdminGestionPersonne extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("personne.jsp");
        ...
        String date_fin = request.getParameter("date_fin");
         ...
         if (nom != null && prenom != null && mail != null && equipe != null && batiment != null && date_debut != null) {
            ...
            if(date_fin != null) {
                p.setDateFin(Date.valueOf(date_fin));
